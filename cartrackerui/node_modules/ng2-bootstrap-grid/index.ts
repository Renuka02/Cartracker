// import { BootstrapGridModule } from './src/bootstrap-grid.module';
// import { BootstrapGridModule } from './index';
...
export { BootstrapGridComponent } from './src/bootstrap-grid/bootstrap-grid.component';
export { ContainerComponent } from './src/container/container.component';
export { RowComponent } from './src/row/row.component';
export { ColSmDirective, ColMdDirective, ColLgDirective } from './src/columns.directive';
export { ColumnComponent } from './src/column/column.component';
export { AlignCenterDirective, AlignLeftDirective, AlignRightDirective, AlignCenterLeftDirective, AlignCenterRightDirective } from './src/directives/alignments.directive';
export { BootstrapGridModule } from './src/bootstrap-grid.module';
